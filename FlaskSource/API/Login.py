        ...
        if request.method == "POST":
            ...
            if userDetailsFromDB:
                ...
                if verify_password(userDetails.getPassword(), password):
                    ...
                    session['user'] = [userDetails.getLoginId(), userDetails.getName(), userDetails.getUserName(),
                                       userDetails.getEmail(), userDetails.getGender(), userDetails.getDateOfBirth(),
                                       userDetails.getPhoneNumber(), userDetails.getGrievances()]
                    return redirect("/")
                else:
